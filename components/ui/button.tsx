...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-button text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-macaron-pink text-white hover:bg-macaron-pink/90",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-macaron-pink bg-background hover:bg-macaron-pink/10 hover:text-macaron-pink",
        secondary:
          "bg-macaron-green text-white hover:bg-macaron-green/90",
        ghost: "hover:bg-macaron-pink/10 hover:text-macaron-pink",
        link: "text-macaron-pink underline-offset-4 hover:underline",
      },
      size: {
