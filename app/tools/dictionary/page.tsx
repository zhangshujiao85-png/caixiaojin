...
import { Search, BookOpen, HelpCircle, ArrowLeft } from "lucide-react";
...
export default function DictionaryPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-macaron-blue/20 via-macaron-cream to-macaron-purple/20 py-8 md:py-12">
      <div className="container mx-auto px-4 md:px-6 max-w-4xl">
        ...
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-macaron-blue to-macaron-purple flex items-center justify-center shadow-lg animate-bounce" style={{ animationDuration: "2s" }}>
        ...
        <div className="relative mb-6">
          ...
          <Input
            ...
            className="w-full pl-10 md:pl-12 h-12 md:h-14 text-base rounded-full border-2 border-macaron-blue/30 focus:border-macaron-blue/60 bg-white shadow-sm"
          />
        </div>
        ...
        <div className="flex flex-wrap gap-2 mb-6 justify-center">
          {categories.map((category) => (
            <button
              ...
              className={cn(
                "px-4 py-2 rounded-full text-sm font-cute transition-all duration-300",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filteredTerms.map((term) => (
            <div
              key={term.id}
              className="bg-white rounded-2xl p-5 shadow-md hover:shadow-lg transition-all duration-300 border-2 border-macaron-blue/20 hover:border-macaron-blue/40 hover:scale-102"
            >
              {/* 术语头部 */}
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800 font-cute mb-1">
                      {term.term}
                    </h3>
                ...
                <HelpCircle className="w-5 h-5 text-macaron-blue" />
              </div>
              ...
              <div className="mb-3">
                ...
                <p className="text-gray-700 leading-relaxed">{term.simpleExplain}</p>
              </div>

              {/* 举例说明 */}
              <div className="bg-macaron-cream rounded-xl p-3 border-2 border-macaron-yellow/30">
